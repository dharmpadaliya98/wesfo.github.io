...
!function (e, i) {
    ...
    "use strict";
    var i = Array.prototype.slice, n = t.console, c = void 0 === n ? function () {
    } : function (t) {
        n.error(t)
    };
    ...
    function $(t) {
        if (function () {
            ...
            for (var n = i.isBorderBox = "border-box" == e.boxSizing, o = 0; o < _; o++) {
                var s = v[o], r = e[s], a = parseFloat(r);
                i[s] = isNaN(a) ? 0 : a
            }
            var l = i.paddingLeft + i.paddingRight, h = i.paddingTop + i.paddingBottom,
                d = i.marginLeft + i.marginRight, c = i.marginTop + i.marginBottom,
                u = i.borderLeftWidth + i.borderRightWidth, p = i.borderTopWidth + i.borderBottomWidth, g = n && x,
                m = y(e.width);
    ...
    return d.htmlInit = function (a, l) {
        d.docReady(function () {
            var t = d.toDashed(l), o = "data-" + t, e = document.querySelectorAll("[" + o + "]"),
                i = document.querySelectorAll(".js-" + t), n = d.makeArray(e).concat(d.makeArray(i)),
                s = o + "-options", r = h.jQuery;
    ...
    var r = t.console, a = t.jQuery, l = 0, h = {};
    ...
    return i._resetLayout = function () {
        ...
        var e = h(t), i = this._getElementOffset(t), n = this._getOption("originLeft") ? i.left : i.right,
    ...
    var c = function (t) {
        ...
        var e = l(t).split(" "), i = e[0], n = i.match(/^\[(.+)\]$/), o = function (e, i) {
            return e ? function (t) {
        ...
        }(n && n[1], i), s = h.sortDataParsers[e[1]];
            ...
            var e = function (l, h) {
                return function (t, e) {
                    for (var i = 0; i < l.length; i++) {
                        var n = l[i], o = t.sortData[n], s = e.sortData[n];
                        if (s < o || o < s) {
                            var r = void 0 !== h[n] ? h[n] : h, a = r ? 1 : -1;
                            return (s < o ? 1 : -1) * a
                        }
                    }
                    return 0
    ...
    h.Defaults = {
        ...
        var i = this.current(), n = null, o = t - this.relative(i), s = (0 < o) - (o < 0), r = this._items.length,
    ...
    n.Defaults = {animateOut: !1, animateIn: !1}, n.prototype.swap = function () {
        if (1 === this.core.settings.items && r.support.animation && r.support.transition) {
            ...
            this.core.current() !== this.previous && (s && (t = this.core.coordinates(this.previous) - this.core.coordinates(this.next), i.one(r.support.animation.end, e).css({left: t + "px"}).addClass("animated owl-animated-out").addClass(s)), o && n.one(r.support.animation.end, e).addClass("animated owl-animated-in").addClass(o))
        }
    ...
    var r = o("<support>").get(0).style, a = "Webkit Moz O ms".split(" "), i = {
        transition: {
            end: {
    ...
    r.DEFAULTS = {
        ...
        return this.each(function () {
            var t = s(this), e = t.data("countTo"), i = "object" == typeof o ? o : {},
    ...
    n.fn.disappear = function (e, t) {
        ...
        return this.each(function () {
            ...
            if (s.appeared = !1, i) {
                function e() {
                    if (s.is(":visible")) {
                        var t = r.scrollLeft(), e = r.scrollTop(), i = s.offset(), n = i.left, o = i.top;
    ...
    function n(e, i) {
        ...
        if (void 0 !== r) n.renderer = r; else {
            if ("undefined" == typeof SVGRenderer) throw new Error("Please load either the SVG- or the CanvasRenderer");
            n.renderer = SVGRenderer
        }
        var o = {}, s = 0, t = function () {
    ...
    (function (t) {
        ...
        var l = -1 < navigator.userAgent.indexOf("MSIE ") || -1 < navigator.userAgent.indexOf("Trident/") || -1 < navigator.userAgent.indexOf("Edge/"),
            a = function () {
                ...
                return !1
            }(), y = void 0, v = void 0, h = void 0, c = !1, u = !1;
        ...
        function f() {
            if (g.length) {
                ...
                var e = c || !m || m.width !== y || m.height !== v, i = u || e || !m || m.y !== h;
                u = c = !1, (e || i) && (g.forEach(function (t) {
                    e && t.onResize(), i && t.onScroll()
                }), m = {width: y, height: v, y: h}), (0, n.default)(f)
            }
        }
        ...
        function _(t) {
            ...
            for (var e = arguments[1], i = Array.prototype.slice.call(arguments, 2), n = t.length, o = 0, s = void 0; o < n; o++) if ("object" === (void 0 === e ? "undefined" : d(e)) || void 0 === e ? t[o].jarallax || (t[o].jarallax = new b(t[o], e)) : t[o].jarallax && (s = t[o].jarallax[e].apply(t[o].jarallax, i)), void 0 !== s) return s;
            return t
        }
        ...
        var w = !!t.ResizeObserver && new t.ResizeObserver(function (t) {
            ...
            key: "init", value: function () {
                ...
                if ("static" === t.css(t.$item, "position") && t.css(t.$item, {position: "relative"}), "auto" === t.css(t.$item, "z-index") && t.css(t.$item, {zIndex: 0}), t.image.$container = document.createElement("div"), t.css(t.image.$container, e), t.css(t.image.$container, {"z-index": t.options.zIndex}), l && t.css(t.image.$container, {opacity: .9999}), t.image.$container.setAttribute("id", "jarallax-container-" + t.instanceID), t.$item.appendChild(t.image.$container), t.image.useImgTag ? i = t.extend({
                ...
                }, e, i))), "opacity" !== t.options.type && "scale" !== t.options.type && "scale-opacity" !== t.options.type && 1 !== t.options.speed || (t.image.position = "absolute"), "fixed" === t.image.position) for (var s = 0, r = t.$item; null !== r && r !== document && 0 === s;) {
            ...
            key: "coverImage", value: function () {
                var t, e = this, i = e.image.$container.getBoundingClientRect(), n = i.height, o = e.options.speed,
                    s = "scroll" === e.options.type || "scroll-opacity" === e.options.type, r = 0, a = n;
            ...
            key: "onScroll", value: function (t) {
                ...
                if (e.options.elementInViewport && (r = e.options.elementInViewport.getBoundingClientRect()), e.isElementInViewport = 0 <= r.bottom && 0 <= r.right && r.top <= v && r.left <= y, t || e.isElementInViewport) {
                    var a = Math.max(0, n), l = Math.max(0, o + n), h = Math.max(0, -n), d = Math.max(0, n + o - v),
                        c = Math.max(0, o - (n + o - v)), u = Math.max(0, -n + v - o), p = 1 - 2 * (v - n) / (v + o),
                        g = 1;
        ...
        function $(t, e) {
            ...
            var n = i.$item.getAttribute("data-jarallax"), o = JSON.parse(n || "{}");
    ...
    function i(t) {
        if (void 0 === E.$boxer) {
            var e = g(this), i = t.data.$object, n = e[0].href && e[0].href || "", o = e[0].hash && e[0].hash || "",
                s = n.toLowerCase().split(".").pop().split(/\#|\?/)[0], r = e.data("boxer-type") || "",
                ...
                d = "element" === r || !a && !l && !h && "#" === o.substr(0, 1), c = void 0 !== i;
    ...
    function n() {
        var t = y();
        E.isMobile || E.duration, E.isMobile || E.$controls.css({marginTop: (E.contentHeight - E.controlHeight - E.metaHeight) / 2}), !E.visible && E.isMobile && E.gallery.active && E.$content.on("touchstart.boxer", ".boxer-image", d), (E.isMobile || E.fixed) && E.$body.addClass("boxer-open"), E.$boxer.on(I, function (t) {
    ...
    function c(t) {
        ...
        var i = -E.delta;
        i < E.touchMin && (i = E.touchMin, E.canSwipe = !1), i > E.touchMax && (i = E.touchMax, E.canSwipe = !1), E.$image.css({transform: "translate3D(" + i + "px,0,0)"}), E.touchTimer = p(E.touchTimer, 300, function () {
            u(t)
        })
    }

    function u(t) {
        C(t), z(E.touchTimer), E.$boxer.off("touchmove.boxer touchend.boxer"), E.delta && (E.$boxer.addClass("animated"), E.swipe = !1, E.canSwipe && (E.delta > E.edge || E.delta < -E.edge) ? (E.swipe = !0, E.$image.css(E.delta <= E.leftPosition ? {transform: "translate3D(" + E.contentWidth + "px,0,0)"} : {transform: "translate3D(" + -E.contentWidth + "px,0,0)"})) : E.$image.css({transform: "translate3D(0,0,0)"}), E.swipe && E.$controls.filter(E.delta <= E.leftPosition ? ".previous" : ".next").trigger("click"), p(E.resetTimer, E.duration, function () {
            ...
            close: function () {
                ...
                return void 0 !== E.$boxer && ("object" != typeof t && (E.targetHeight = t, E.targetWidth = arguments[1]), "element" === E.type ? l(E.$content.find(">:first-child")) : "image" === E.type ? s() : "video" === E.type && a(), function () {
                    if (E.visible && !E.isMobile) {
                        var t = y();
                        E.$controls.css({marginTop: (E.contentHeight - E.controlHeight - E.metaHeight) / 2}), E.$boxer.css({
                            height: E.contentHeight + E.paddingVertical,
                            width: E.contentWidth + E.paddingHorizontal,
                            top: E.fixed ? 0 : t.top
                        })
    ...
    "use strict";
    var c = document.documentElement, u = d(window),
        o = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";

    function t() {
        var o, t = document.getElementById("top-bar"), e = document.getElementById("top-bar__navigation-toggler"),
            i = document.getElementById("top-bar__navigation"), s = d(t), r = d(e), n = d(i), a = n.find("li a"),
            l = n.find(".submenu"), h = !1;
        l.length && l.parents("li").addClass("has-children"), o = r.is(":visible") ? 70 : 80, a.on("touchend click", function (t) {
            var e = d(this), i = e.parent();
            if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
                var n = d(this.hash);
                return (n = n.length ? n : d("[name=" + this.hash.slice(1) + "]")).length && d("html,body").stop().animate({scrollTop: n.offset().top - o}, 1e3), r.is(":visible") && (s.removeClass("expanded"), r.removeClass("active")), !1
            }
    ...
    function n() {
        var t = document.getElementById("btn-to-top-wrap"), e = d(t);
        if (0 < e.length) {
            var i = document.getElementById("btn-to-top"), n = d(i), o = n.data("visible-offset");
    ...
    _fixed_menu = function () {
        var t = document.getElementById("top-bar"), e = d(t), i = e.next("header").innerHeight() - 80, n = !1;
        ...
        _fixed_menu(), t(), function () {
            ...
            var t = document.getElementById("gallery-set"), n = d(t);
            if (0 < n.length) {
                var o = d(".js-isotope");
                n.find("a").on("click", function (t) {
                    var e = d(this), i = e.data("cat");
            ...
            0 < t.length && t.each(function (t, e) {
                d(e).on("submit", function () {
                    var e = d(this), t = e.serialize(), i = e.find(".form__note");
                    return d.ajax({
        ...
        var t = d(".js-isotope");
        t.length && t.isotope("layout"), function () {
            var n = d(".g_map");
            if (0 < n.length) {
                ...
                d.getScript(e, function (t, e, i) {
                    n.each(function () {
                        var t = d(this), e = new google.maps.LatLng(t.attr("data-longitude"), t.attr("data-latitude")),
                            i = t.attr("data-marker"), n = {
                                zoom: 14,
                                center: e,
                                ...
                                zoomControl: !1,
                                disableDefaultUI: !0
                            }, o = new google.maps.Map(t[0], n), s = new google.maps.StyledMapType([{
                                featureType: "all",
                                elementType: "all",
